    <div class="container top">
      ...
      <div class="page-header users-header">
        <h2>
          <?php echo ucfirst($this->uri->segment(2));?>
          <br/>
          <?php echo $count_emails; ?>
          <br/>
   
          <a  href="<?php echo site_url("admin").'/'?>Emails/add" class="btn btn-success">Add new Email</a>
          <br/>
          <?php 
            if (isset($unVerfied_Emails)&&!empty($unVerfied_Emails))
             echo'<a  href="'.site_url("admin").'/Emails/verfied" class="btn btn-success">Show Verified Emails</a>';
            else
              echo'<a  href="'.site_url("admin").'/Emails/unverfied" class="btn btn-success">Show unVerified Emails</a>';
