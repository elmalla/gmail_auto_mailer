    <div class="container top">
      ...
      echo form_open('admin/Owner/add', $attributes);
      ?>
        <fieldset>
          <div class="control-group">
            <label for="inputError" class="control-label">Owner Name</label>
            <div class="controls">
              <input type="text" id="" name="owner_name" value="<?php echo set_value('owner_name'); ?>" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="owner_id" value="<?php echo set_value('owner_id'); ?>">
