    ...
    */
    public function index()
    {
        ...
        if($order_type){
            ...
            if($this->session->userdata($products_prefix.'order_type')){
                $order_type = $this->session->userdata($products_prefix.'order_type');    
            }else{
        ...
        if($manufacture_id !== false && $search_string !== false && $order !== false || $this->uri->segment(3) == true){ 
            ...
            */
            ...
            if($manufacture_id !== 0){
                $filter_session_data[$products_prefix.'manufacture_selected'] = $manufacture_id;
            }else{
                $manufacture_id = $this->session->userdata($products_prefix.'manufacture_selected');
            }
            $data['manufacture_selected'] = $manufacture_id;

            if($search_string){
                $filter_session_data[$products_prefix.'search_string_selected'] = $search_string;
            }else{
                $search_string = $this->session->userdata($products_prefix.'search_string_selected');
            }
            $data['search_string_selected'] = $search_string;

            if($order){
                $filter_session_data[$products_prefix.'order'] = $order;
            }
            else{
                $order = $this->session->userdata($products_prefix.'order');
            }
            $data['order'] = $order;
            ...
            $filter_session_data[$products_prefix.'manufacture_selected'] = null;
            $filter_session_data[$products_prefix.'search_string_selected'] = null;
            $filter_session_data[$products_prefix.'order'] = null;
            $filter_session_data[$products_prefix.'order_type'] = null;
            $this->session->set_userdata($filter_session_data);
